        ...
        <div className='flex flex-col md:flex-row md:justify-start justify-center items-center py-2 shadow-md sticky top-0 bg-white z-10'>
            ...
            <div ref={ref} className={`SLIDECART z-[999] w-75 h-[100vh] absolute top-0 right-0 bg-pink-100 px-8 py-10 transform transition-transform  translate-x-full }`}>
                ...
                {/* {Object.keys(cart).length !== 0 && */}
                    <div className="flex">
                       <Link href={"/checkout"}> <button className="flex mr-2 text-white bg-pink-500 border-0 py-2 px-3 focus:outline-none hover:bg-pink-600 rounded text-sm"><BsBagCheckFill className='m-1' />Checkout</button></Link>
