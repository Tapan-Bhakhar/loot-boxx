        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center">
            ...
            <div className="lg:w-1/5 md:w-1/2 p-4 w-full shadow-lg m-4">
              ...
              <p className="block relative z-0 rounded overflow-hidden">
                  <img alt="ecommerce" className="mx-auto h-[200px] w-[200px] object-contain p-2 bg-white rounded" src="https://m.media-amazon.com/images/I/31I6THUNl8L._SY445_SX342_.jpg" />
                  ...
                  {/* <img alt="ecommerce" className="mx-auto md:h-[36vh] block" src="..." /> */}
                </p>
                <div className="mt-4">
